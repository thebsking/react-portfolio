...
function Project() {
    const projectArr = [
        {
            title: 'Loo Review',
            img: '%PUBLIC_URL%/assets/loo-review.gif',
            link: '/Project-02',
        ...
        },
        {
            ...
            img: '%PUBLIC_URL%/assets/weather-search.gif',
            link: '/weather-search',
        ...
        {
            title: 'Budget App',
            img: '%PUBLIC_URL%/assets/screenshot.png',
            link: '/pwa-budget',
            ...
            title: 'Tech Blog',
            img: '%PUBLIC_URL%/assets/preview.gif',
            link: 'tech-blog',
        ...
        },
        {
            ...
            img: '%PUBLIC_URL%/assets/sorted.png',
